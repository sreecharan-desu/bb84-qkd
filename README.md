...
**[Download Full Research Paper (PDF)](paper/bb84_fingerprint_paper.pdf)**
...
![QBER Delta Analysis](plots/fingerprint_analysis.png)
...
![SKR Comparison](plots/skr_comparison.png)
...
The [notebook.ipynb](notebook.ipynb) serves as the primary research artifact for reproducibility. It employs a high-performance **vectorized numerical state-vector engine** suitable for large-scale Monte Carlo analysis.
